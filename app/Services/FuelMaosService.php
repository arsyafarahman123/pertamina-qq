    ...
    protected function knowledgeBase(): array
    {
        return [
            ...
            [
                ...
                'answer' => "📐 **Rumus Perhitungan Density 15°C (Standar Baku ASTM D1250 / API 2540 / IP 200 Table 53B)**\n\nSistem secara otomatis mengoreksi densitas terukur (ρt) pada suhu t (°C) ke densitas standar 15°C (ρ15) secara iteratif:\n\n**Persamaan Utama ASTM Table 53B:**\n1. Selisih Suhu: Δt = t - 15\n2. Koefisien Muai Termal: α15 = (K0 / ρ15²) + (K1 / ρ15)\n3. Densitas Terkoreksi: ρ15 = ρt × exp[ α15 × Δt × (1 + 0.8 × α15 × Δt) ]\n\n**Konstanta Berdasarkan Rentang ρ15:**\n• **Gasoline / Naphtha** (653 ≤ ρ15 < 770 kg/m³): K0 = 346.4228, K1 = 0.4388\n• **Zona Transisi** (770 ≤ ρ15 < 778 kg/m³): α15 = A + (B / ρ15²), dengan A = -0.00336312, B = 2680.3206\n• **Kerosene / Jet Fuel** (778 ≤ ρ15 < 839 kg/m³): K0 = 594.5418, K1 = 0.0\n• **Solar / Gas Oil** (839 ≤ ρ15 ≤ 1075 kg/m³): K0 = 186.9696, K1 = 0.48618\n\n*Catatan: Nilai dihitung secara iteratif sampai selisih antar iterasi < 0.00001 kg/m³.*",
