...
<div class="w-full overflow-x-auto pb-8 flex justify-center">
    <div id="area-cetak" class="w-[794px] max-w-[794px] min-h-[1050px] shrink-0 bg-white px-6 py-4 shadow-2xl rounded-sm text-[9px] leading-tight box-border flex flex-col justify-between">
        <div>
