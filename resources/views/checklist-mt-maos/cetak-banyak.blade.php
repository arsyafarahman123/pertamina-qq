    ...
    @foreach ($checklists as $index => $checklist)
        ...
        <div class="w-full overflow-x-auto flex justify-center">
            <div id="lembar-{{ $checklist->id }}"
                 ...
                 class="lembar-cetak-item w-[794px] max-w-[794px] shrink-0 bg-white px-7 py-6 shadow-2xl rounded-sm text-[9px] leading-normal box-border relative">
                ...
                <div class="flex items-center justify-between border-b-2 border-black pb-2 mb-2">
                    ...
                    <div class="text-center font-bold px-2">
                        ...
                        <h2 class="text-[10px] font-black uppercase tracking-widest text-slate-800">FUEL TERMINAL MAOS</h2>
                    </div>
                    
                    <div class="text-right text-[8px] font-semibold text-slate-700 leading-tight">
                        <div class="text-slate-500 uppercase tracking-wider text-[7px]">QC &amp; QA Department</div>
                        <div class="font-bold text-black text-[8.5px]">Checklist MT Armada</div>
                    </div>
                </div>

                {{-- 2. METADATA KIRI --}}
                <div class="mb-2 text-[9px] font-semibold text-black leading-tight space-y-0.5">
                    <div class="flex items-center"><span class="w-24 font-bold">NOMOR POLISI</span><span class="mr-2">:</span><span class="font-black text-[10px] tracking-wide">{{ $checklist->nomor_polisi }}</span></div>
                    <div class="flex items-center"><span class="w-24">PEMILIK</span><span class="mr-2">:</span><span>{{ $checklist->pemilik ?: '-' }}</span></div>
                    <div class="flex items-center"><span class="w-24">Tanggal</span><span class="mr-2">:</span><span>{{ $checklist->tanggal_periksa->translatedFormat('d F Y') }}</span></div>
                </div>

                {{-- 3. TABEL PEMERIKSAAN LENGKAP --}}
                <table class="tbl-form w-full text-[8.5px]">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-1 text-[8px]">Pelaksanaan pengecekan masa tera MT</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="p-0 align-middle">
                                @foreach($teraList as $idx => $t)
                                    <div class="flex items-center {{ !$loop->last ? 'border-b border-black' : '' }} py-1 px-2">
                                        <div class="w-14 shrink-0 font-bold bg-slate-100 text-[8px] text-center border-r border-black py-0.5 mr-2 flex items-center justify-center">
                                            Komp. {{ $t['komp'] ?? ($idx + 1) }}
                                        </div>
                                        <div class="flex-1 grid grid-cols-2 text-[8px] leading-tight gap-x-2 font-medium text-slate-900">
                            ...
                            <td class="p-0 align-middle">
                                @foreach($teraList as $idx => $t)
                                    <div class="flex items-center {{ !$loop->last ? 'border-b border-black' : '' }} py-1 px-2">
                                        <div class="w-full grid grid-cols-2 text-[8px] leading-tight gap-x-2 font-bold text-slate-900">
                            ...
                            <td class="px-2 py-1 align-middle leading-snug text-[8px]">
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="px-2 py-0.5 font-bold bg-slate-200">Manhole :-</td>
                        </tr>
                        @php
                            $sec3Sub = [
                        ...
                        @foreach($sec3Sub as $m)
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-0.5">{{ $m['item'] }}</td>
                                ...
                                <td class="px-2 py-0.5 text-[8px] leading-snug">{{ $m['ket'] }}</td>
                            </tr>
                        @endforeach
                        ...
                        <tr>
                            ...
                            <td class="px-2 py-0.5 font-bold bg-slate-200">Bracket :</td>
                            <td class="text-center py-0.5 bg-slate-200"></td>
                            <td class="text-center py-0.5 bg-slate-200"></td>
                            <td class="text-center py-0.5 bg-slate-200"></td>
                            <td class="px-2 py-0.5 font-bold text-[8px] bg-slate-200 leading-snug">Menahan Handle &amp; Bracket ( Mayor )</td>
                        </tr>
                        @php
                            $sec4Sub = [
                        ...
                        @foreach($sec4Sub as $b)
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-0.5">{{ $b['item'] }}</td>
                                ...
                                <td class="px-2 py-0.5 text-[8px] leading-snug">{{ $b['ket'] }}</td>
                            </tr>
                        @endforeach
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="px-2 py-0.5 font-bold bg-slate-200">Sight Glass :</td>
                        </tr>
                        @php
                            $sec5Sub = [
                        ...
                        @foreach($sec5Sub as $s)
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-0.5">{{ $s['item'] }}</td>
                                ...
                                <td class="px-2 py-0.5 text-[8px] leading-snug">{{ $s['ket'] }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <div class="mt-5 flex items-start justify-between text-[9px] text-black px-4">
